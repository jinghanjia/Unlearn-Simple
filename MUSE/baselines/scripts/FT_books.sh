...
FORGET="../data/$CORPUS/raw/combined.txt"
RETAIN="../data/$CORPUS/raw/retain1.txt"

TARGET_DIR="swj0419/7b_iclm"
...
for max_len in '2048'; do
for rho in '0.01' '0.1' '0.5' '0.05'; do
    python ft.py \
        --algo sam \
        --model_dir $TARGET_DIR --tokenizer_dir $LLAMA_DIR \
        --data_file $FORGET --retain_data_file $RETAIN \
        --out_dir "./ckpt/$CORPUS/sam_rho${rho}_combined${max_len}" \
